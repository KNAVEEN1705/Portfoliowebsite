...
export default function Header() {
    ...
    return (
        <header className="flex justify-between px-5 py-3 bg-primary font-Home-font">
            <a className='font-bold text-black font-Home-font' href="/" aria-label='Home page'>NAVEEN.K</a>
